...
def renamePaises(listaOriginal,lista3LetrasPaises,variantesTotales):
    ...
    BEL = ['BEL','BELGICA','BLGICA','BELJICA','BL','BELGIUM','BELGI','BELG','BELGRANO']
    ...
    KSA = ['KSA','ARABIASAUDITA','ARABIASAUDI','SAUDIARABIA','ARABIA','SAUDIAR','ARAB','ARABSAU','SAUDARABIA']
    MEX = ['MEX','MEXICO','MEJICO','MXICO','MÉXICO','MX','MEXIVO','MÉX']
    ...
    COP = ['COP']
    ARJ = ['ARJ','ARGENTINOJR']
    ATU = ['ATU','ATLTICOTUCUMN']
    BAR = ['BAR']
    EST = ['EST','ESTUDIANTES']
    GIM = ['GIM','GIMNASIA']
    GOD = ['GOD','GODOCRUZ']
    IND = ['IND']
    IRM = ['IRM','INDEPENDIENTEDERIVADAVIA']
    NOB = ['NOB','NEWELLS']
    SAR = ['SAR','SARMIENTO']
    VEL = ['VEL','VLEZ','VELEZ']
    CCO = ['CCO','CENTRALCRDOBA']
    YPF = ['YPF','PF']
    HUR = ['HUR','HURACAN','HURACN']
    PLA = ['PLA','PLATENSE']
    BOC = ['BOC','BOCA']
    INS = ['INS','INSTITUTO']
    LAN = ['LAN','LANS','LANUS']
    SEM = ['SEM','SEMILLERO']
    RAC = ['RAC','RACING']
    CEN = ['CEN','ROSARIOCENTRAL']
    SLO = ['SLO','SANLORENZO']
    TIG = ['TIG','TIGRE']
    UNI = ['UNI','UNION']
    DYJ = ['DYJ','DEFENSAJUSTICIA','DJ']
    TAL = ['TAL','TALLERES']

    paisesFigus = [FWC,ARG,AUS,BEL,BRA,CAN,CMR,CRC,CRO,DEN,ECU,ENG,ESP,FRA,GER,GHA,IRN,JPN,KOR,KSA,MEX,MRR,NED,POL,POR,QAT,SEN,SRB,SUI,TUN,URU,USA,WAL,COCA,INT,HCI,PER,CHI,VEN,JAM,PAN,BOL,COL,PAR,HON,TRI,LEG,ROH,RIV,RIE,BAN,LPF,COP,ARJ,ATU,BAR,EST,GIM,GOD,IND,IRM,NOB,SAR,VEL,CCO,HUR,PLA,YPF,BOC,INS,LAN,SEM,RAC,CEN,SLO,TIG,UNI,DYJ,TAL]
    listaDePaises = []
